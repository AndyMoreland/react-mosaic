...
var data = {
    ...
    render: function()
    {
        ...
        return (<div className={classes} style={this.style()} onMouseDown={this._onMouseDown} onTouchStart={this._onTouchStart} onMouseMove={this._onMouseMove} onTouchMove={this._onTouchMove} onMouseUp={this._onMouseUp} onMouseLeave={this._onMouseLeave} onMouseOut={this._onMouseOut} onTouchEnd={this._onTouchEnd}>
