        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                React.DOM.div({className: "toolbar-portrait mui-app-bar"}, 
                    React.DOM.div({className: "toolbar-portrait__section", style: this._matrixStyle()}, 
                        React.DOM.span({className: "toolbar-portrait__section-btn mdfi_image_grid_on", onMouseDown: this._onMatrixMouseDown})
                    ), 

                    React.DOM.div({className: "toolbar-portrait__section", style: this._imageStyle()}, 
                    ...
                    React.DOM.div({className: "toolbar-portrait__section", style: this._spyStyle()}, 
