        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                React.DOM.div({className: "toolbar-landscape"}, 
                    ...
                    React.DOM.div({className: "toolbar-landscape__section"}, 
                        Icon({icon: "action-visibility", onMouseDown: this._spyStart, onTouchStart: this._spyStart, onMouseUp: this._spyStop, onMouseLeave: this._spyStop, onMouseOut: this._spyStop})
                    )
                ), 
