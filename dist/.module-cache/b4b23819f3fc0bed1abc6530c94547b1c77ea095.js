...
var Chunk = React.createClass({displayName: 'Chunk',
    ...
    render:function()
    {
        ...
        return (React.DOM.div({className: classes, style: this.style(), onMouseDown: this._onMouseDown, onTouchStart: this._onTouchStart, onMouseMove: this._onMouseMove, onMouseUp: this._onMouseUp}, 
