...
var Chunk = React.createClass({displayName: 'Chunk',
    ...
    render:function()
    {
        ...
        return (React.DOM.div({className: classes, style: this.style(), onClick: this.clickHandler, onMouseDown: this._onMouseDown}, 
...
console.log('_onMouseDown',e.clientX,e.clientY,e.pageX,e.pageY,e.screenX,e.screenY);
    }
});
