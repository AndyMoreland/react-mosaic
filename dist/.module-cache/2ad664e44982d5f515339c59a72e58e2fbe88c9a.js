    ...
    Pane = React.createClass({displayName: 'Pane',
        ...
        render: function()
        {
            ...
            return (React.DOM.div({className: "pane", style: this._style()}, 
                ...
                React.DOM.div({className: "pane__spy", style: this._spyStyle(), onMouseDown: this._onSpyMouseDown, onMouseUp: this._onSpyMouseUp, onMouseLeave: this._onSpyMouseLeave}, 
