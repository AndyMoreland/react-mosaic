...
var React = require('react'),
    ...
    Pane = React.createClass({displayName: 'Pane',
        ...
        render: function()
        {
console.log('render',this.state.nextImage.src);
            var chunks = [],
                chunkImage = {
            ...
            return (React.DOM.div({className: "pane", style: this._style()}, 
                ...
                React.DOM.div({className: "pane__img-loader"}, React.DOM.img({ref: "paneImgEl", src: (this.state.nextImage.src)?this.state.nextImage.src:''}))
            ));
        },
