    ...
    Pane = React.createClass({displayName: 'Pane',
        ...
        render: function()
        {
            ...
            return (React.DOM.div({className: "pane", style: this._style()}, 
                ...
                React.DOM.div({className: "pane__spy", 
                    style: this._spyStyle(), 
                    onMouseDown: this._onSpyMouseDown, 
                    onTouchStart: this._onSpyTouchStart, 
                    onMouseUp: this._onSpyMouseUp, 
                    onMouseLeave: this._onSpyMouseLeave, 
                    onTouchEnd: this._onSpyTouchEnd, 
                    onTouchCancel: this._onSpyTouchCancel}, 
                        Icon({icon: "action-visibility"})
                )
            ));
        },
        ...
        _spyStyle: function()
        {
            var chunkEdge = this.state.edge / this.state.matrix[0],
                fontSize =  chunkEdge / 2,
                left = this.state.hole[0] * chunkEdge + fontSize / 2,
                top = this.state.hole[1] * chunkEdge + fontSize / 2;
...
//         _onSpyMouseUp: function()
//         {
// console.log('_onSpyMouseUp');
//             PaneActions.spyStop();
//         },

//         _onSpyMouseLeave: function()
//         {
// console.log('_onSpyMouseLeave');
//             PaneActions.spyStop();
//         },

//         _onSpyTouchEnd: function()
//         {
// console.log('_onSpyTouchEnd');
//             PaneActions.spyStop();
//         },

//         _onSpyTouchCancel: function()
//         {
// console.log('_onSpyTouchCancel');
//             PaneActions.spyStop();
//         }
});
