    ...
    Header = React.createClass({displayName: 'Header',
        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                Dialog({ref: "gameDialog", title: "Are you realy want stop the game?"}, 
                    PaperButton({label: "Yes", href: "#", onClick: this._setMatrix33}), 
                    PaperButton({label: "No", href: "#", onClick: this._setMatrix44})
                ), 
