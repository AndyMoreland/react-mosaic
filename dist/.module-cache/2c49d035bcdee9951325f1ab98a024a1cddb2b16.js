        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar"}, 
                Dialog({ref: "matrixDialog"}, 
                    PaperButton({type: "DEFAULT", onClick: this._setMatrix33, label: "Set matrix 3x3"}), 
                    PaperButton({type: "DEFAULT", onClick: this._setMatrix44, label: "Set matrix 4x4"}), 
                    PaperButton({type: "DEFAULT", onClick: this._setMatrix55, label: "Set matrix 5x5"})
                ), 
