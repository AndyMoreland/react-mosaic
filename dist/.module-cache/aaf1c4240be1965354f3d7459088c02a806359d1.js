...
var Chunk = React.createClass({displayName: 'Chunk',
    ...
    render:function()
    {
        ...
        return (React.DOM.div({className: classes, style: this.style(), onClick: this.clickHandler, onMouseDown: this._onMouseDown, onMouseMove: this._onMouseMove, onMouseUp: this._onMouseUp, onDrag: this._onDrag, onDragEnd: this._onDragEnd, onDragEnter: this._onDragEnter, onDragExit: this._onDragExit, onDragLeave: this._onDragLeave, onDragOver: this._onDragOver, onDragStart: this._onDragStart, onDrop: this._onDrop}, 
...
console.log('_onDragEnter',e.clientX,e.clientY);
    }, 
    _onDragExit: function(e){
console.log('_onDragExit',e.clientX,e.clientY);
    }, 
    _onDragLeave: function(e){
console.log('_onDragLeave',e.clientX,e.clientY);
    },
    _onDragOver: function(e){
console.log('_onDragOver',e.clientX,e.clientY);
    }, 
    _onDragStart: function(e){
console.log('_onDragStart',e.clientX,e.clientY);
    }, 
    _onDrop: function(e){
console.log('_onDrop',e.clientX,e.clientY);
    }
});
