    ...
    NextButton = React.createClass({displayName: 'NextButton',
        ...
        render: function()
        {
            ...
            return (React.DOM.div({className: "pane", style: this._style()}, 
                ...
                Next({paneEdge: this.state.edge, onMouseDown: this._onNext}), 
                React.DOM.div({className: "pane__nav pane__nav_next", style: this._navStyleNext()}, 
                    React.DOM.span({className: "pane__nav-icon pane__nav-icon_next mui-icon mdfi_hardware_keyboard_arrow_right", style: this._navIconStyleNext(), onMouseDown: this._onNext})
                ), 
