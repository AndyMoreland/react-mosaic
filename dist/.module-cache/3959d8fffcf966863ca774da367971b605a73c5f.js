            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                React.DOM.div({className: "toolbar-portrait mui-app-bar"}, 
                    React.DOM.div({className: "grid_cols_12"}, 
                        React.DOM.div({className: "grid__module grid__module_col_1 grid__module_span_6 toolbar-portrait__section-wrap"}, 
                            React.DOM.div({className: "toolbar-portrait__section"}, 
                                Icon({icon: "image-grid-on", onMouseDown: this._onMatrixMouseDown})
                            )
                        ), 
                        React.DOM.div({className: "grid__module grid__module_col_6 grid__module_span_6 toolbar-portrait__section-wrap"}, 
                            React.DOM.div({className: "toolbar-portrait__section"}, 
                                Icon({icon: "image-photo-library", onMouseDown: this._onImageMouseDown})
                            )
                        )
                    ...
                    React.DOM.div({className: "grid_cols_12"}, 
                        ...
                        React.DOM.div({className: "grid__module grid__module_col_7 grid__module_span_6 toolbar-portrait__section-wrap"}, 
                            React.DOM.div({className: "toolbar-portrait__section"}, 
                                Icon({icon: "action-visibility", onMouseDown: this._onSpyMouseDown})
                            )
                        )
