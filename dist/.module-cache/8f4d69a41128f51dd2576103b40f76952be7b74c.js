...
var React = require('react'),
    ...
    Pane = React.createClass({displayName: 'Pane',
        ...
        componentDidMount: function()
        {
            ...
            if (isVerticalImage) 
            {
                image.scaledImageHeight = edge * imageKoef;
                image.topOffset = (image.scaledImageHeight - edge) / 2;
            } else 
            {
                image.scaledImageWidth = edge / imageKoef;
                image.leftOffset = (image.scaledImageWidth - edge) / 2;
            }
        ...
        render: function()
        {
            var chunks = [],
                chunkImage = {
                    ...
                    scaledImageWidth: this.state.image.scaledImageWidth,
                    scaledImageHeight: this.state.image.scaledImageHeight,
