...
console.log('_onTouchStart',e.touches[0].clientX,e.touches[0].clientY);
...
console.log('_onTouchEnd',e.changedTouches[0].clientX,e.changedTouches[0].clientY);
for (var key in e)
    console.log(key,e[key]);
        this._dragEnd(Math.floor(e.touches[0].clientX), Math.floor(e.touches[0].clientY));
    },
...
console.log('_dragMove right',dx);
    ...
    _dragEng: function(x,y){
        ...
        switch (this.state.crawlDist)
        {
            case 'top':
                dy = y - this.state.touchStartCoords.y;
console.log('_dragEng',dy,this.state.edgePx);
...
console.log('_dragEng',dy,this.state.edgePx);
            ...
            case 'left':
                dx = x - this.state.touchStartCoords.x; 
console.log('_dragEng',dx,this.state.edgePx);
