        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                React.DOM.div({className: "toolbar-landscape"}, 
                    ...
                    React.DOM.div({className: "toolbar-landscape__section"}, 
                        Icon({icon: "action-visibility", onMouseDown: this._spyStart, onTouchStart: this._spyStart, onMouseUp: this._spyStop, onMouseLeave: this._spyStop, onMouseOut: this._spyStop, onTouchEnd: this._spyStop, onTouchCancel: this._spyStop})
                    )
                ), 
                ...
                React.DOM.div({className: "toolbar-portrait mui-app-bar"}, 
                    ...
                    React.DOM.div({className: "toolbar-portrait__section"}, 
                        React.DOM.span({className: "toolbar-portrait__section-btn mdfi_action_visibility", onMouseDown: this._spyStart, onTouchStart: this._spyStart, onMouseUp: this._spyStop, onMouseLeave: this._spyStop, onMouseOut: this._spyStop, onTouchEnd: this._spyStop, onTouchCancel: this._spyStop})
                    )
                )
            ));
        },
