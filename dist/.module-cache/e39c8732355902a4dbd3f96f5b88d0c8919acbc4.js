    ...
    Header = React.createClass({displayName: 'Header',
        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar"}, 
                Dialog({ref: "matrixDialog"}, 
                    PaperButton({onClick: this._setMatrix33, label: "Set matrix 3x3", type: "FLAT"}), 
                    PaperButton({onClick: this._setMatrix44, label: "Set matrix 4x4", type: "FLAT"}), 
                    PaperButton({onClick: this._setMatrix55, label: "Set matrix 5x5", type: "FLAT"}), 
                    "// ", React.DOM.div({className: "toolbar__dialog-link mui-paper-button mui-z-depth-1 mui-rounded", onMouseDown: this._setMatrix33}, "Set matrix 3x3"), 
                    "// ", React.DOM.div({className: "toolbar__dialog-link mui-paper-button mui-z-depth-1 mui-rounded", onMouseDown: this._setMatrix44}, "Set matrix 4x4"), 
                    "// ", React.DOM.div({className: "toolbar__dialog-link mui-paper-button mui-z-depth-1 mui-rounded", onMouseDown: this._setMatrix55}, "Set matrix 5x5")
                ), 
