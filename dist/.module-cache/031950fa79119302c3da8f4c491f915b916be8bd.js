...
var Chunk = React.createClass({displayName: 'Chunk',
    ...
    render:function()
    {
        ...
        return (React.DOM.div({className: classes, style: this.style(), onClick: this.clickHandler, onMouseDown: this._onMouseDown, onMouseMove: this._onMouseMove, onMouseUp: this._onMouseUp}, 
