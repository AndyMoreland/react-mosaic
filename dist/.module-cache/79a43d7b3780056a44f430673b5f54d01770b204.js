        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                Dialog({ref: "matrixDialog", title: "Set matrix"}, 
                    React.DOM.div({className: "toolbar__dialog-link", onMouseDown: this._setMatrix33}, "3x3"), 
                    React.DOM.div({className: "toolbar__dialog-link", onMouseDown: this._setMatrix44}, "4x4"), 
                    React.DOM.div({className: "toolbar__dialog-link", onMouseDown: this._setMatrix55}, "5x5")
                ), 

                React.DOM.div({className: "toolbar toolbar_landscale"}
                    
                ), 

                React.DOM.div({className: "toolbar toolbar_portrait mui-app-bar grid_cols_12"}, 
