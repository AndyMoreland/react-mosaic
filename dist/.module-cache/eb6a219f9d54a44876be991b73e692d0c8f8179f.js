    ...
    Pane = React.createClass({displayName: 'Pane',
        ...
        render: function()
        {
            ...
            return (React.DOM.div({className: "pane", style: this._style()}, 
                ...
                React.DOM.div({className: "pane__spy", style: this._spyStyle()}, 
        ...
        _spyStyle: function()
        {
            var chunkEdge = this.state.edge / this.state.matrix[0],
                ...
                left = this.state.hole[0] * chunkEdge + chunkEdge / 2,
                top = this.state.hole[1] * chunkEdge + chunkEdge / 2;
...
console.info('hole',PaneStore.getHole());
        },
