        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar"}, 
                Dialog({ref: "matrixDialog"}, 
                    React.DOM.div({onMouseDown: this._setMatrix33}, "Set matrix 3x3"), 
                    React.DOM.div({onMouseDown: this._setMatrix44}, "Set matrix 4x4"), 
                    React.DOM.div({onMouseDown: this._setMatrix55}, "Set matrix 5x5")
                ), 
