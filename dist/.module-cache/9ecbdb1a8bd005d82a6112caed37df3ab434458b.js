            ...
            return (React.DOM.div({className: "toolbar-container"}, 
                ...
                React.DOM.div({className: "toolbar-portrait mui-app-bar"}, 
                    React.DOM.div({className: "toolbar-portrait__section"}, 
                        React.DOM.span({className: "mui-icon mdfi_image-grid-on", onMouseDown: this._onMatrixMouseDown})
                    ), 

                    React.DOM.div({className: "toolbar-portrait__section"}, 
                        React.DOM.span({className: "mdfi_image-photo-library", onMouseDown: this._onImageMouseDown})
                    ), 
                    ...
                    React.DOM.div({className: "toolbar-portrait__section"}, 
                        React.DOM.span({className: "mdfi_action_visibility", onMouseDown: this._onSpyMouseDown})
                    )
                )
            ));
        },
