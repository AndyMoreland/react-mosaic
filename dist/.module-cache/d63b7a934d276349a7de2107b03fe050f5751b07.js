    ...
    Pane = React.createClass({displayName: 'Pane',
        ...
        render: function()
        {
            ...
            return (React.DOM.div({className: "pane", style: this._style()}, 
                ...
                React.DOM.div({className: "pane__next"}, 
                    React.DOM.span({className: "pane__next-icon mui-icon mdfi_hardware_keyboard_arrow_right", onMouseDown: this._onNext, onTouchStart: this._onNext})
                )
            ));
        },
