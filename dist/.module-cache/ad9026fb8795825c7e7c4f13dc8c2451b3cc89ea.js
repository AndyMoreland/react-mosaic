        ...
        render : function(){
            ...
            return (React.DOM.div({className: "toolbar"}, 
                Dialog({ref: "matrixDialog", title: "Set matrix"}, 
                    PaperButton({className: "toolbar__dialog-btn", type: "FLAT", onClick: this._setMatrix33, label: "3x3"}), 
                    PaperButton({type: "FLAT", onClick: this._setMatrix44, label: "4x4"}), 
                    PaperButton({type: "FLAT", onClick: this._setMatrix55, label: "5x5"})
                ), 
